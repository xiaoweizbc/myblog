...
# 第一部分：front_article_list.html，front_article_detail.html
# 渲染front_article_list.html
...
# 第二部分：front_signin.html，front_signup.html
# 渲染front_signin.html
@require_http_methods(['GET', 'POST'])
def signin(request):  # 前台登录
